...
.table-header {
    display: grid;
    grid-template-columns: 1.5fr 1fr 1.2fr 1fr 1fr 1fr 1fr 1.5fr;
    gap: 15px;
    padding: 15px 20px;
    background: #5b1f1f;
    color: white;
        ...
        <?php else: ?>
            ...
            <?php foreach ($applications as $app): ?>
                <div class="table-row">
                    ...
                    <div>
                        <?php 
                        // Priority: 1. resume_path from job_applications, 2. resume_link from users, 3. check uploads folder
                        ...
                        if (!empty($resume_path)): 
                            // Resume uploaded with application - highest priority
