...
// Try to get resume_json from job_applications first
$resume_json = $application['resume_json'] ?? '';

// If not in job_applications, try to get from generated_resumes table
...
// Include resume generation functions
require_once __DIR__ . '/../openai_config.php';

// Function to create resume prompt (copied from resume_builder.php)
    ...
    <div class="viewer-header">
        <div>
            ...
            <div class="student-info">
                ...
                | <strong>Position:</strong> <?php echo htmlspecialchars($application['job_role'] ?? $application['job_title'] ?? 'N/A'); ?>
            </div>
        </div>
        <div style="display: flex; gap: 10px;">
            ...
            <a href="track_applications.php" class="btn btn-primary">
