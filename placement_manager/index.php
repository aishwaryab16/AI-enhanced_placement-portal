    ...
    <div class="dashboard-container">
        ...
        <div class="section-card">
            ...
            <div class="module-grid">
                ...
                <!-- Interview Results -->
                <div class="module-card">
                    <div class="module-icon"><i class="fas fa-trophy"></i></div>
                    <h3 class="module-title">Interview Results</h3>
                    <p class="module-description">View interview performance and top performers</p>
                    <ul class="module-features">
                        <li>All Students Interview Scores</li>
                        <li>Top 5 Performers List</li>
                        <li>Company-wise Results</li>
                        <li>Round-wise Performance</li>
                        <li>Performance Analytics</li>
                    </ul>
                    <a href="interview_results.php" class="action-btn">
