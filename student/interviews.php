...
<body>
    ...
    <div class="main-wrapper">
        <!-- Top Bar -->
        <div class="top-bar">
            <div class="breadcrumb">Interviews / Company Interviews</div>
        </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php foreach ($past as $i): 
                                $score = isset($i['score']) && $i['score'] !== null ? (int)$i['score'] : null;
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="feedback-text">
                                            <?php echo !empty($i['feedback']) ? htmlspecialchars($i['feedback']) : '<span style="color: #9ca3af;">No feedback provided</span>'; ?>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
